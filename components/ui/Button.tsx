...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      outline:
        'bg-transparent border-2 border-purple-500 text-purple-400 hover:bg-purple-500/10 focus:ring-purple-500',
      ghost:
        'bg-transparent text-gray-300 hover:bg-gray-800 focus:ring-gray-600',
      danger:
